      ...
      def self.locale_en_us
        {
          commands: {
            oevertex: {
              ...
              vcb_hint:      "Enter: update  |  Tab: insertion  |  Shift: mode  |  ↑: roll  |  ↓: axis  |  PgUp/PgDn: adjust  |  Ins: reset  |  Esc: cancel"
            },
            oecenter: {
            ...
            oeuscale: {
              ...
              vcb_hint: "Shift: mode  |  ↑: roll  |  Esc: cancel"
            },
            oeflow: {
            ...
            oeface: {
              ...
              offset_prompt: "Offset",
              vcb_hint:      "Enter: update  |  Tab: insertion  |  Shift: orientation  |  ↑: roll  |  ↓: axis  |  PgUp/PgDn: adjust  |  Ins: reset  |  Esc: cancel",
