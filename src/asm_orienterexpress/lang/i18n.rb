  ...
  module OrienterExpress
    module Lang
      ...
      def self.configure(locale)
        ...
        Sketchup.require "asm_orienterexpress/lang/locales/#{file}"
      ...
      def self.dump
        ...
        merged[:html][:info] = {
          ...
          copyright:   INFO_COPY,
          description: EXTENSION[:description].to_s,
          url_ew:      EXTENSION[:url_ew].to_s,
          url_su:      EXTENSION[:url_su].to_s,
          url_gh:      EXTENSION[:url_gh].to_s
        }.freeze
      ...
      def self.format_update_date
        ASM_Extensions::OrienterExpress.format_update_date(@locale)
      end
